            ...
            if( have_posts() ):
                ...
                while( have_posts() ): the_post();
                    ...
                    *  Verifica se funçao existe e se existe conteúdo "navigation"
                     * v0.1 : Criado
                     * v0.3 : Corrigido a verificação de variavel com suporte a PHP 5.4
                     */
                    if( function_exists('get_field') ){
                        ...
                        * v0.3: Alterado o carregamento de vários templates via include. Agora o conteúdo é definido via 
                        */
