...
<?php
    ...
    */
    protected function lpccp_update_values(){
        ...
        //Array para inserir
        $to_options = (key_exists('lpccp-enable-item', $request))? $request['lpccp-enable-item'] : [];
    ...
    *  @since 0.1
    *  v0.3.3 - Verifica se página submetida é de administração do plugin
    */
    public function lpccp_notices(){

        //Verifica se página corrente é do plugin, senão returna
        $page = get_current_screen();
        if($page->base != 'settings_page_'.SETTINGS_SLUG) {
            return;
        }
